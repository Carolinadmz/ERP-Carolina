...
const customHeader = (
    ...
    <div className="profile-image-container">
        <img
        src={user?.picture || `https://www.gravatar.com/avatar/${user?.email ? btoa(user.email) : "0"}?d=mp`}
        alt="Profile"
        className="profile-image"
        />
    </div>
    <div className="header-content">
        <h2>{user?.name || "Carolina Domínguez Pérez"}</h2>
...
return (
    ...
    <div className="about-me-content">
        ...
        <div className="contact-buttons">
            ...
            onClick={() => (window.location.href = `mailto:${user?.email || "contacto@ejemplo.com"}`)}
            />
            <Button
            icon="pi pi-linkedin"
            label="LinkedIn"
