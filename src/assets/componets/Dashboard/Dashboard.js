...
const clientesData = {
    ...
    datasets: [
    {
        ...
        hoverBackgroundColor: ["#FF4569", "#2693E6", "#FFBD31", "#36B2B2", "#8A50FF"],
    },
    ],
}
...
return (
    ...
    <div className="dashboard-grid">
        ...
        <Card
            ...
            subTitle="Resumen de clientes por categoría"
            className="kpi-card kpi-clientes"
        >
            ...
            <div className="kpi-details">
                <p>
                <strong>Campaña de Marketing:</strong> <span>10</span>
                </p>
                <p>
                <strong>Clientes Activos:</strong> <span>100</span>
                </p>
                <p>
                <strong>Clientes Potenciales:</strong> <span>20</span>
                </p>
                <p>
                <strong>Clientes Perdidos:</strong> <span>5</span>
                </p>
                <p>
                <strong>Clientes Ganados:</strong> <span>10</span>
                </p>
                <p className="kpi-total">
                <strong>Total:</strong> <span>145</span>
                </p>
            </div>
            </div>
        </Card>
        ...
        <Card
            ...
            subTitle="Distribución de personal"
            className="kpi-card kpi-empleados"
        >
            <div className="kpi-chart">
